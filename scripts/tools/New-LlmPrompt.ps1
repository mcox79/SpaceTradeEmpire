...
try {
  ...
  [void]$sb.Append("- Format: comma-separated header, PASS or FAIL directly after gate id (space-separated, no pipe), parenthetical summary, then Evidence." + $nl)
  [void]$sb.Append("- Example: ""- 2026-02-27, main, GATE.X.FOO.001 PASS (description; proof values; test count). Evidence: path1;path2""" + $nl)
  [void]$sb.Append("- No pipes anywhere in the line." + $nl)
  [void]$sb.Append("- Parenthetical summary must contain ALL of:" + $nl)
  ...
  [void]$sb.Append("- Evidence: semicolon-separated repo-relative paths (no spaces around semicolons)" + $nl + $nl)
