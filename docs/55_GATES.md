...
| GATE.S7.COMBAT_PHASE2.HEAT_SYSTEM.001 | TODO | Heat accumulation + overheat cascade |
| GATE.S7.COMBAT_PHASE2.BATTLE_STATIONS.001 | TODO | Battle stations state machine |
| GATE.X.LEDGER.TX_MODEL.001 | TODO | Transaction event entity + logging |
| GATE.S9.SYSTEMIC.TRIGGER_ENGINE.001 | TODO | World-state mission trigger detection |
| GATE.X.STATION_IDENTITY.VISUAL.001 | TODO | Station visual variety per faction (F6) |
| GATE.X.HYGIENE.REPO_HEALTH.031 | TODO | Full test suite + health baseline |
| GATE.X.UI_POLISH.DASHBOARD_UX.001 | TODO | Dashboard Needs Attention UX fix (F11) |
| GATE.X.UI_POLISH.MARKET_FORMAT.001 | TODO | Market production text formatting (F12) |
| GATE.S7.COMBAT_PHASE2.RADIATOR.001 | TODO | Radiator module — targetable, affects cooling |
| GATE.S9.SYSTEMIC.OFFER_GEN.001 | TODO | Generate mission offers from triggers |
| GATE.S7.COMBAT_PHASE2.CONTRACT.001 | TODO | Contract tests: heat + battle stations + radiator |
| GATE.S7.COMBAT_PHASE2.BRIDGE.001 | TODO | SimBridge heat/battleStations/radiator queries |
| GATE.X.LEDGER.BRIDGE.001 | TODO | SimBridge transaction ledger queries |
| GATE.S9.SYSTEMIC.BRIDGE.001 | TODO | SimBridge systemic mission queries |
| GATE.X.LEDGER.INTEGRITY.001 | TODO | Ledger integrity — sum transactions = balance |
| GATE.S7.COMBAT_PHASE2.HEAT_HUD.001 | TODO | Heat gauge + battle stations HUD widget |
| GATE.S9.SYSTEMIC.HEADLESS.001 | TODO | Headless proof: systemic missions from world state |
| GATE.X.HYGIENE.EPIC_REVIEW.031 | TODO | Epic status audit + T32 anchor rec |
| GATE.X.HYGIENE.FIRST_HOUR_EVAL.031 | TODO | First-hour bot eval w/ combat heat |
| GATE.X.PERF.TICK_BASELINE.001 | TODO | Tick budget performance baseline |
