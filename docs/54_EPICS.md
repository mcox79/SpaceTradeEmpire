...
Status: IN_PROGRESS — Fracture travel, commerce, econ invariants, discovery outcomes, galaxy map, Fracture Discovery Event, Layered Reveals, Planet Scan (T42-T43) all DONE. Remaining: Anomaly Ecology, Artifact Research (T2/T3 modules exist now), Tech Leads (T2/T3 modules exist now), Science Center, Expedition programs, UI Discovery, Class Discovery Profiles, Mystery Markers.
