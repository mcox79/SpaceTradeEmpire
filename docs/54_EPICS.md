...
- EPIC.S7.GALAXY_MAP_V2.V0 [IN_PROGRESS]: Galaxy map evolution — 5 new overlay modes (Faction Territory, Exploration, Fleet Positions, Warfronts, Heat), route planner with multi-hop path display, galaxy search (find system by name), semantic zoom (detail levels by altitude), constellation clustering, icon toggles. Per GalaxyMap.md. GameShell-only; SimBridge queries: GetFactionTerritoryOverlayV0, GetFleetPositionsV0, GetWarfrontOverlayV0, GetHeatOverlayV0, GetRouteV0, GetSystemSearchV0. 7/9 gates DONE, remaining: Exploration overlay, Warfront overlay (gates: GATE.S7.GALAXY_MAP_V2.*)
...
- EPIC.S7.GALAXY_MAP_V2.V0 [IN_PROGRESS]: Galaxy map evolution per GalaxyMap.md — 5 new overlay modes (Faction Territory/Exploration/Fleet Positions/Warfronts/Heat), route planner, galaxy search, semantic zoom, constellation clustering, icon toggles. 7/9 gates DONE, remaining: Exploration overlay, Warfront overlay. GameShell-only (gates: GATE.S7.GALAXY_MAP_V2.*)
...
Status: IN_PROGRESS — 42 DONE epics in S7. Newly closed: T2 Module Catalog, Combat Feel Polish, Risk Meter UI, Narrative Delivery, Fleet Tab, Main Menu. Remaining TODO/IN_PROGRESS: Galaxy Map V2 (2 gates left), Runtime Stability (8 gates in T25), Automation Management (7 gates), Faction Identity Redesign, Warfront State, Tech Access, Diplomacy Verbs, UI (Diplo + Warfront).
